...
public class Payment implements Serializable{
    ...
    private Reservation appointment = new Reservation(4.0, 4.0, Calendar.getInstance(), Calendar.getInstance(), Calendar.getInstance(), new Uzer("mozzarella", "volante", "pic", "Milano, piazza leonardo", 5), new Uzer("sbiribilla", "volante", "pic", "Milano, piazza leonardo", 5), AppointmentStatus.REQUESTED);
